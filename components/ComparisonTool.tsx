  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-11 gap-4 items-center">
        ...
        {/* W2 Side */}
        <div className="md:col-span-5 bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800 shadow-xl backdrop-blur-sm">
        ...
        <div className="md:col-span-1 flex justify-center">
          <div className="bg-zinc-800 border border-zinc-700 p-3 rounded-full text-white shadow-lg">
            <ArrowRight className="w-6 h-6 rotate-90 md:rotate-0" />
          </div>
        </div>

        {/* 1099 Side */}
        <div className="md:col-span-5 bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800 shadow-2xl backdrop-blur-sm">
